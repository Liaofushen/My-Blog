...
insert  into `tb_config`(`config_name`,`config_value`,`create_time`,`update_time`) values ('yourEmail','liaofushen.xyz','2018-11-11 20:33:17','2019-05-07 21:56:23');
...
insert  into `tb_link`(`link_id`,`link_type`,`link_name`,`link_url`,`link_description`,`link_rank`,`is_deleted`,`create_time`) values (3,2,'十三的博客','http://liaofushen.xyz','个人独立博客13blog',14,0,'2018-10-22 19:53:34');
